                                        ...
                                        <div class="thumbnail">
                                            ...
                                            <div class="caption">
                                                ...
                                                <p>
                                                    ...
                                                    <a class="btn btn-xs btn-danger remove_file" data-company="{{ $company->id }}" data-file="{{ $file->id }}" data-filetype="invoice"><span class="glyphicon glyphicon-trash"></span></a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-6 col-sm-2 col-md-2" id="file_panel_{{ $file->id }}">
                                        <div class="thumbnail">
                                            ...
                                            <div class="caption">
                                                ...
                                                <p>
                                                    <a class="btn btn-xs btn-success" href="{{ $file->file_path }}"><span class="glyphicon glyphicon-download"></span></a>
                                                    <a class="btn btn-xs btn-danger remove_file" data-company="{{ $company->id }}" data-file="{{ $file->id }}" data-filetype="dn"><span class="glyphicon glyphicon-trash"></span></a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-6 col-sm-2 col-md-2" id="file_panel_{{ $file->id }}">
                                        <div class="thumbnail">
                                            ...
                                            <div class="caption">
                                                ...
                                                <p>
                                                    <a class="btn btn-xs btn-success" href="{{ $file->file_path }}"><span class="glyphicon glyphicon-download"></span></a>
                                                    <a class="btn btn-xs btn-danger remove_file" data-company="{{ $company->id }}" data-file="{{ $file->id }}" data-filetype="cn"><span class="glyphicon glyphicon-trash"></span></a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-6 col-sm-2 col-md-2" id="file_panel_{{ $file->id }}">
                                        <div class="thumbnail">
                                            ...
                                            <div class="caption">
                                                ...
                                                <p>
                                                    <a class="btn btn-xs btn-success" href="{{ $file->file_path }}"><span class="glyphicon glyphicon-download"></span></a>
                                                    <a class="btn btn-xs btn-danger remove_file" data-company="{{ $company->id }}" data-file="{{ $file->id }}" data-filetype="logo"><span class="glyphicon glyphicon-trash"></span></a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-6 col-sm-2 col-md-2" id="file_panel_{{ $file->id }}">
                                        <div class="thumbnail">
                                            ...
                                            <div class="caption">
                                                ...
                                                <p>
                                                    <a class="btn btn-xs btn-success" href="{{ $file->file_path }}"><span class="glyphicon glyphicon-download"></span></a>
                                                    <a class="btn btn-xs btn-danger remove_file" data-company="{{ $company->id }}" data-file="{{ $file->id }}" data-filetype="profile"><span class="glyphicon glyphicon-trash"></span></a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-6 col-sm-2 col-md-2" id="file_panel_{{ $file->id }}">
                                        <div class="thumbnail">
                                            ...
                                            <div class="caption">
                                                ...
                                                <p>
                                                    <a class="btn btn-xs btn-success" href="{{ $file->file_path }}"><span class="glyphicon glyphicon-download"></span></a>
                                                    <a class="btn btn-xs btn-danger remove_file" data-company="{{ $company->id }}" data-file="{{ $file->id }}" data-filetype="support"><span class="glyphicon glyphicon-trash"></span></a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-6 col-sm-2 col-md-2" id="file_panel_{{ $file->id }}">
                                        <div class="thumbnail">
                                            ...
                                            <div class="caption">
                                                ...
                                                <p>
                                                    <a class="btn btn-xs btn-success" href="{{ $file->file_path }}"><span class="glyphicon glyphicon-download"></span></a>
                                                    <a class="btn btn-xs btn-danger remove_file" data-company="{{ $company->id }}" data-file="{{ $file->id }}" data-filetype="registration"><span class="glyphicon glyphicon-trash"></span></a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-6 col-sm-2 col-md-2" id="file_panel_{{ $file->id }}">
                                        <div class="thumbnail">
                                            ...
                                            <div class="caption">
                                                ...
                                                <p>
                                                    <a class="btn btn-xs btn-success" href="{{ $file->file_path }}"><span class="glyphicon glyphicon-download"></span></a>
                                                    <a class="btn btn-xs btn-danger remove_file" data-company="{{ $company->id }}" data-file="{{ $file->id }}" data-filetype="others"><span class="glyphicon glyphicon-trash"></span></a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" role="form" method="POST" action="/company/save_company_file/{{ $company->id }}" enctype="multipart/form-data">
        ...
        $('.remove_file').click(function(){
            if (confirm('Are you sure you want to delete this file?')) {
                ...
                $.ajax({
                    type: "DELETE",
                    data: data,
                    url: '/company/delete_company_file/'+file_id+'/'+company_id,
