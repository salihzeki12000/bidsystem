                                        ...
                                        <div class="thumbnail">
                                            ...
                                            <div class="caption">
                                                ...
                                                <p>
                                                    ...
                                                    <a class="btn btn-xs btn-danger remove_file" data-company="{{ $job->company_id }}" data-job="{{ $job->id }}" data-file="{{ $file->id }}" data-filetype="invoice"><span class="glyphicon glyphicon-trash"></span></a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-6 col-sm-2 col-md-2" id="file_panel_{{ $file->id }}">
                                        <div class="thumbnail">
                                            ...
                                            <div class="caption">
                                                ...
                                                <p>
                                                    <a class="btn btn-xs btn-success" href="{{ $file->link_path }}"><span class="glyphicon glyphicon-download"></span></a>
                                                    <a class="btn btn-xs btn-danger remove_file" data-company="{{ $job->company_id }}" data-job="{{ $job->id }}" data-file="{{ $file->id }}" data-filetype="dn"><span class="glyphicon glyphicon-trash"></span></a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-6 col-sm-2 col-md-2" id="file_panel_{{ $file->id }}">
                                        <div class="thumbnail">
                                            ...
                                            <div class="caption">
                                                ...
                                                <p>
                                                    <a class="btn btn-xs btn-success" href="{{ $file->link_path }}"><span class="glyphicon glyphicon-download"></span></a>
                                                    <a class="btn btn-xs btn-danger remove_file" data-company="{{ $job->company_id }}" data-job="{{ $job->id }}" data-file="{{ $file->id }}" data-filetype="cn"><span class="glyphicon glyphicon-trash"></span></a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-6 col-sm-2 col-md-2" id="file_panel_{{ $file->id }}">
                                        <div class="thumbnail">
                                            ...
                                            <div class="caption">
                                                ...
                                                <p>
                                                    <a class="btn btn-xs btn-success" href="{{ $file->link_path }}"><span class="glyphicon glyphicon-download"></span></a>
                                                    <a class="btn btn-xs btn-danger remove_file" data-company="{{ $job->company_id }}" data-job="{{ $job->id }}" data-file="{{ $file->id }}" data-filetype="logo"><span class="glyphicon glyphicon-trash"></span></a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-6 col-sm-2 col-md-2" id="file_panel_{{ $file->id }}">
                                        <div class="thumbnail">
                                            ...
                                            <div class="caption">
                                                ...
                                                <p>
                                                    <a class="btn btn-xs btn-success" href="{{ $file->link_path }}"><span class="glyphicon glyphicon-download"></span></a>
                                                    <a class="btn btn-xs btn-danger remove_file" data-company="{{ $job->company_id }}" data-job="{{ $job->id }}" data-file="{{ $file->id }}" data-filetype="profile"><span class="glyphicon glyphicon-trash"></span></a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-6 col-sm-2 col-md-2" id="file_panel_{{ $file->id }}">
                                        <div class="thumbnail">
                                            ...
                                            <div class="caption">
                                                ...
                                                <p>
                                                    <a class="btn btn-xs btn-success" href="{{ $file->link_path }}"><span class="glyphicon glyphicon-download"></span></a>
                                                    <a class="btn btn-xs btn-danger remove_file" data-company="{{ $job->company_id }}" data-job="{{ $job->id }}" data-file="{{ $file->id }}" data-filetype="support"><span class="glyphicon glyphicon-trash"></span></a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-6 col-sm-2 col-md-2" id="file_panel_{{ $file->id }}">
                                        <div class="thumbnail">
                                            ...
                                            <div class="caption">
                                                ...
                                                <p>
                                                    <a class="btn btn-xs btn-success" href="{{ $file->link_path }}"><span class="glyphicon glyphicon-download"></span></a>
                                                    <a class="btn btn-xs btn-danger remove_file" data-company="{{ $job->company_id }}" data-job="{{ $job->id }}" data-file="{{ $file->id }}" data-filetype="registration"><span class="glyphicon glyphicon-trash"></span></a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-6 col-sm-2 col-md-2" id="file_panel_{{ $file->id }}">
                                        <div class="thumbnail">
                                            ...
                                            <div class="caption">
                                                ...
                                                <p>
                                                    <a class="btn btn-xs btn-success" href="{{ $file->link_path }}"><span class="glyphicon glyphicon-download"></span></a>
                                                    <a class="btn btn-xs btn-danger remove_file" data-company="{{ $job->company_id }}" data-job="{{ $job->id }}" data-file="{{ $file->id }}" data-filetype="others"><span class="glyphicon glyphicon-trash"></span></a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
